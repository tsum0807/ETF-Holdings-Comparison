...
EXCHANGE_ALIAS_LIST = [ASX_EXCHANGE_ALIAS, US_EXCHANGE_ALIAS, JPX_EXCHANGE_ALIAS, DKK_EXCHANGE_ALIAS, FP_EXCHANGE_ALIAS, LSE_EXCHANGE_ALIAS]
EXCHANGE_ALIAS_NAMES = ["ASX", "US", "JPX", "DKK", "FP", "LSE"]
